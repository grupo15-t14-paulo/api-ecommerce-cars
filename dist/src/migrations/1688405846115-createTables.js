...
exports.CreateTables1688405846115 = void 0;
class CreateTables1688405846115 {
    constructor() {
        this.name = 'CreateTables1688405846115';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "comment" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "carId" uuid, "userId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`CREATE TYPE "public"."cars_typecar_enum" AS ENUM('Diesel', 'Etanol', 'Gasolina', 'Flex', 'Elétrico', 'Híbrido', 'Não informado')`);
            ...
            yield queryRunner.query(`CREATE TABLE "images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "urlImage" character varying(255) NOT NULL, "carId" uuid, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_cb77c129bb5afaca6648b869aa2" FOREIGN KEY ("carId") REFERENCES "cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "cars" ADD CONSTRAINT "FK_6431b6fec12c4090bb357fba2c2" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`DROP TYPE "public"."cars_typecar_enum"`);
...
exports.CreateTables1688405846115 = CreateTables1688405846115;
